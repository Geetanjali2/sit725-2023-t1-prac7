...
let url = 'http://localhost:3000/api/pic';
let pic = {paht:'',title:''}
...
describe('test POST api', function(){
    it('post pic to DB', function(done){
        request.post({url:url,form:pic}, function(a,b,c){
            //todo asserts here
            done();
        });
    });
...
describe('test DELETE api', function(){
    it('delete a pic', function(done){
        request.delete({url:url,form:pic}, function(a,b,c){
            //todo asserts here
            done();
        });
    });
